...
const SplitBox: React.FC<SplitBoxProps> = ({ box, onUpdate, onSplit, isSelected, onSelect }) => {
    ...
    <div className="content" style={{ padding: `${box.padding.top}px ${box.padding.right}px ${box.padding.bottom}px ${box.padding.left}px` }}>
      ...
      >
        ...
        <div className="controls">
          <button onClick={(e) => { e.stopPropagation(); onSplit(); }}>Split</button>
          <button onClick={(e) => { e.stopPropagation(); setShowColorPicker(!showColorPicker); }}>Color</button>
          <button onClick={(e) => { e.stopPropagation(); fileInputRef.current?.click(); }}>Image</button>
          <input
            type="file"
            ref={fileInputRef}
            style={{ display: 'none' }}
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (!target.closest('.inner-content') && !target.closest('.color-picker')) {
